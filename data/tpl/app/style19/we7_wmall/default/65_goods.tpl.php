...
<div class="page store shopcategory" id="page-app-goods">
	...
	<header class="bar bar-nav common-bar-nav">
		<a class="icon fa fa-arrow-left pull-left back" href="http://www.richmei.com/app/index.php?i=65&c=entry&do=index&m=we7_wmall"></a>
		<div class="title open-popup" data-popup=".popup-privilege"><?php  echo $store['title'];?>
		&nbsp;&nbsp;&nbsp;
		<a href="http://www.richmei.com/app/index.php?i=65&c=entry&do=index&m=we7_wmall"style="font-size:12px">[切换]</a>
		</div>
	...
	<div class="buttons-tab">
		...
		<a href="<?php  echo $this->createMobileUrl('store', array('sid' => $store['id']));?>" class="button">配送信息</a>
	</div>
								...
								<li id="goods-<?php  echo $ds['id'];?>">
									...
									<div class="item-inner">
										...
										<div class="item-text">
											...
											<div style="font-size:12px"><?php  echo $ds['intro'];?></div>										
										</div>
									</div>
								</a>
...
<?php  $sqllo="SELECT * FROM ". tablename("goto_history"). " WHERE openid='".$_SESSION['openid']."'";
	 $missionlo=pdo_fetch($sqllo);?>
<script>
$(function(){
	...
	$('#btnSubmit').click(function(){
		...
		// }
		//判断距离
		//lng:113.955992,lat:22.587754
		if(sessionStorage.getItem("is_first")!=1){
			sessionStorage.setItem("is_first",1); 
		   lng="<?php  echo $missionlo['lng']?>";
		   lat="<?php  echo $missionlo['lat']?>";
		}
