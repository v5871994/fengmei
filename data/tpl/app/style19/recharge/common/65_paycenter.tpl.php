...
<!--微信卡券-->
<?php  if($you == 1 && $_W['card_permission']) { ?>
<h4>优惠券</h4>
<div class="panel">
	...
	<div class="clearfix" style="padding:5px, 0;display:none" id="card-info">
		<p>使用优惠券 :<span class="pull-right"><?php  echo $card['title'];?></span></p>
	...
	wx.ready(function(){
		$('#card').click(function(){
			wx.chooseCard({
				...
				nonceStr:'<?php  echo $randstr;?>',
				signType:'SHA1',
				cardSign:'<?php  echo $signature;?>',
...
<?php  } ?>
<!--【10:10】卡券-->
<?php  if($pay['card']['switch'] == 3 && !empty($cards)) { ?>
	<div id="coupon">
		<h4>优惠券</h4>
		<div class="panel">
			<div class="clearfix" style="padding:5px, 0" id="card">
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body" style="max-height:400px;overflow-y:scroll">
							<?php  if(is_array($cards)) { foreach($cards as $li) { ?>
							<label class="form-group">
								<div class="col-xs-2">
									<i class="fa fa-check-circle fa-lg" data-id="<?php  echo $li['couponid'];?>"></i>
								</div>
								<div class="col-xs-10">
									<?php  if($li['type'] == 1) { ?>
									<span class="label label-danger">折扣券</span> <?php  echo $li['title'];?> &nbsp;满<?php  echo $li['condition'];?>打<?php  echo $li['discount'] * 10;?>折
									<?php  } else { ?>
									<span class="label label-success">代金券</span> <?php  echo $li['title'];?> &nbsp;满<?php  echo $li['condition'];?>减<?php  echo $li['discount'];?>
									<?php  } ?>
...
<ul class="nav nav-tabs" role="tablist" style="margin-bottom:0;">
	...
	<?php  if($pay['delivery']['switch']) { ?><li data-id="delivery" class="delivery"><a href="#collect" role="tab" data-toggle="tab">货到付款</a></li><?php  } ?>
	<?php  if($pay['line']['switch']) { ?><li data-id="line" class="line"><a href="#line" role="tab" data-toggle="tab">线下汇款</a></li><?php  } ?>
	<!--li><a href="#">【10:10】担保</a></li-->
</ul>
			...
			<div class="alert alert-info">
				<div class="row text-center">
					<div class="col-xs-4">
						...
						<div class="help-block">付款给【10:10】</div>
					</div>
					<div class="col-xs-4">
						<span class="fa-stack fa-2x">
							<i class="fa fa-adjust fa-stack-2x"></i>
					...
					<div class="col-xs-4">
						...
						<div class="help-block">【10:10】付款给商家</div>
					</div>
				</div>
			</div>
