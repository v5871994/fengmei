...
#mbutton > span{float:right; display:inline-block; background:#E33539; border:1px #DDD solid; color:#FFF; height:30px; line-height:30px; padding:0 10px; margin-left:10px;}
#mcover{position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0, 0, 0, 0.7);display:none;z-index:20000;}
#mcover img{position:fixed;right: 18px;top:5px;width:260px;height:180px;z-index:20001;}
.head{height:40px; line-height:40px; background:#8E1E20; padding:0 5px; color:#FFF;}
...
.head .bn.pull-left{border-right:1px solid #F19373;}
.head .bn.pull-right{position:absolute; right:5px; top:0; border-left:1px solid #F19373;}
...
.head .order{background:#c55355; position:absolute; z-index:9999; right:0;}
...
.head .order li.fa-caret-up{font-size:20px;color:#c55355;position:absolute;top:-11px;right:16px;}
</style>
<div class="head">
