...
<html>
	<head>
		...
		<title><?php  echo $_W['we7_wmall']['config']['title'];?><?php  if(!empty($title)) { ?>-<?php  echo $title;?><?php  } ?></title>
		...
		<link rel="stylesheet" href="../addons/we7_wmall/resource/app/css/light7-swiper.min.css" />
		<link rel="stylesheet" href="../addons/we7_wmall/resource/app/css/index.css?t=<?php  echo time()?>" />
