...
<div class="conainer">
<div class="pay-main">
<img src="../addons/feng_fightgroups/template/image/pay_logo.png">
<div class="lines"><span>微信安全支付</span></div>
</div>
<div class="tips">
<div class="img">
<img src="../addons/feng_fightgroups/template/image/pay_ok.png">
<span>已开启支付安全</span>
</div>
</div>
<div id="action" class="action" onclick="onApiSuccess();">确认支付</div>
...
<input type="hidden" name="paytime" value="0" />
