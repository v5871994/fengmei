...
<div class="ng-cloak panel panel-info ng-container" ng-controller="loginPanel">
	...
	<form name="theform" method="post" role="form" ng-submit="login();">
		<ul class="nav nav-tabs" role="tablist">
			<?php  if($ltype == 'code') { ?>
				<li class="active"><a href="#code" role="tab" data-toggle="tab">验证码登录</a></li>
			<?php  } else if($ltype == 'password') { ?>
		...
		<div class="tab-content">
			...
			<?php  } ?>
			<?php  if($ltype !== 'password') { ?>
				<div class="tab-pane animated <?php  if($ltype == 'code') { ?>active<?php  } ?>" id="code">
