						...
						<tr>
							...
							<td>
								<?php  if($dca['order_type'] == 3) { ?>
									<span class="label label-info"><?php  echo $tables[$dca['table_id']]['title'];?>桌</span>
									<br>
									<span class="label label-info label-br">就餐人数: <?php  echo $dca['person_num'];?></span>
								<?php  } else { ?>
									<span class="label label-info"><?php  echo $table_categorys[$dca['table_cid']]['title'];?></span>
									<br>
									<span class="label label-info label-br"><?php  echo $dca['reserve_time'];?></span>
									<br>
									<span class="<?php  echo $order_reserve_types[$dca['reserve_type']]['css'];?>"><?php  echo $order_reserve_types[$dca['reserve_type']]['text'];?></span>
								<?php  } ?>
							</td>
							<td>
								<?php  if(!$dca['is_pay']) { ?>
							...
							<td style="text-align:right; overflow:visible;">
								<div class="btn-group">
										...
										<div class="btn-group">
											...
											<ul class="dropdown-menu">
												<?php  if($dca['status'] == 1) { ?>
													...
													<li><a href="<?php  echo $this->createWeburl('table_order', array('op' => 'cancel', 'id' => $dca['id']))?>" class="btn-cancel" data-pay="<?php  echo $dca['is_pay'];?>"  data-pay-type="<?php  echo $dca['pay_type'];?>" title="取消订单" data-toggle="tooltip" data-placement="top">取消订单</a></li>
												<?php  } ?>
												<?php  if($dca['status'] == 2) { ?>
									...
									<?php  } ?>
									<?php  if($dca['status'] < 5) { ?>
										<a href="<?php  echo $this->createWeburl('table_order', array('op' => 'cancel', 'id' => $dca['id']))?>" class="btn btn-default btn-sm btn-cancel" data-pay="<?php  echo $dca['is_pay'];?>"  data-pay-type="<?php  echo $dca['pay_type'];?>" title="取消订单" data-toggle="tooltip" data-placement="top">取消订单</a>
									<?php  } ?>
									<?php  if($dca['status'] == 6) { ?>
						...
						<div class="col-xs-12 col-sm-6 order-infos">
							...
							<?php  if($order['order_type'] == 3) { ?>
								<div class="form-group clearfix">
									...
									<div class="col-md-9 form-control-static">
										<?php  echo $order['table']['title'];?>桌 <?php  echo $order['person_num'];?>人就餐
									</div>
								</div>
							<?php  } else { ?>
								<div class="form-group clearfix">
									...
									<div class="col-md-9 form-control-static">
										<?php  echo $order['reserve_time'];?>
									</div>
								</div>
								<div class="form-group clearfix">
									<label class="col-md-3 control-label">桌台：</label>
									<div class="col-md-9 form-control-static">
										<?php  echo $order['table_category']['title'];?>
									</div>
								</div>
								<div class="form-group clearfix">
									<label class="col-md-3 control-label">预定类型：</label>
									<div class="col-md-9 form-control-static">
										<?php  echo $order['reserve_type_cn'];?>
									</div>
								</div>
							<?php  } ?>
