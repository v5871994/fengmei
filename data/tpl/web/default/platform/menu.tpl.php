...
<script type="text/javascript">
	require(['angular', 'jquery.ui', 'underscore'], function(angular, $, _){
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div ng-show="activeMenu.type != 'url';" style="position:relative">
								...
								<span class="help-block">指定点击此菜单时要执行的操作, 你可以在这里输入关键字, 那么点击这个菜单时就就相当于发送这个内容至【10:10】系统</span>
								<span class="help-block"><strong>这个过程是程序模拟的, 比如这里添加关键字: 优惠券, 那么点击这个菜单是, 【10:10】系统相当于接受了粉丝用户的消息, 内容为"优惠券"</strong></span>
							</div>
						</div>
