...
<ul class="nav nav-tabs">
	...
	<li <?php  if($do == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo url('user/fields');?>">字段管理</a></li>
	<li <?php  if(empty($id) && $do == 'post') { ?>class="active"<?php  } ?>><a href="<?php  echo url('user/fields/post');?>">添加字段</a></li>
	<?php  if(!empty($id) && $do == 'post') { ?><li class="active"><a href="<?php  echo url('user/fields/post', array('id' => $id));?>">编辑字段</a></li><?php  } ?>
</ul>
<?php  if($do == 'display') { ?>
...
<div class="table-responsive clearfix">
	...
	<table class="table table-hover">
		...
		<tbody>
			...
			<tr>
				<td>
					<input type="text" class="form-control" style="width:50%;" name="displayorder[<?php  echo $field['id'];?>]" value="<?php  echo $field['displayorder'];?>">
				</td>
	...
	<form class="form-horizontal form" action="" method="post">
		...
		<div class="form-group">
			...
			<div class="col-sm-10 col-xs-12">
				<input type="text" class="form-control" name="field"  value="<?php  echo $item['field'];?>" <?php  if(!empty($item['field'])) { ?>disabled<?php  } ?>>
			</div>
		</div>
		<div class="form-group">
