...
<ul class="nav nav-tabs">
	...
	<li <?php  if($op == 'pt') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('store', array('op' => 'pt'));?>">管理驿站商品</a></li>
</ul>
...
<ul class="nav nav-tabs">
	<li><a href="<?php  echo $this->createWebUrl('ptcategory');?>">添加驿站商品分类</a></li>
