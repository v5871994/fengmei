...
<ul class="nav nav-tabs">
	<li <?php  if($do == 'store') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('ptcategory');?>">添加驿站商品分类</a></li>
	<li <?php  if($do == 'ptgoods') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('ptgoods');?>">驿站商品列表</a></li>
</ul>
<?php  if($op == 'post') { ?>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<input type="text" class="form-control" name="intro" value="<?php  echo $item['intro'];?>">
					</div>
				</div>
				<div class="form-group">
