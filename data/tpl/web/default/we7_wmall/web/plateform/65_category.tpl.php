			...
			<div class="panel-body">
				<div id="tpl">
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							<input type="radio" <?php  if($category['is_hide'] == 1) { ?>checked="checked"<?php  } ?> name="is_hide" value="1">是
							<input type="radio" <?php  if($category['is_hide'] == 0) { ?>checked="checked"<?php  } ?> name="is_hide" value="0">否
						</div>
					</div>
					<hr>
				</div>
