	...
	<div class="panel panel-default" id="step1">
		...
		<div class="panel-body">
			<div class="pull-left" style="width:320px;background:#F4F5F9;margin-right:20px;border:1px solid #E7E7EB">
				...
				<div class="card_section" style="position: relative">
					<div class="shop-panel" id="color-purview" style="background: #a9d92d">
						...
						<div class="msg-area">
							<div class="tick-msg">
								<p><b id="title-purview">优惠券标题</b></p>
								<p id="sub-title-purview">优惠券副标题</p>
							</div>
				...
				<div class="shop-detail">
					<ul class="list">
						<li>
							<div class="li-panel">
								<div class="li-content">优惠券详情</div>
			...
			<div class="pull-left alert form" style="width:700px;position:relative;display:block;" id="form1">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						...
						<div class="help-block">建议填写优惠券提供的服务或商品名称，描述卡券提供的具体优惠。不超过9个字符</div>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label"> 优惠券副标题(可选)</label>
					<div class="col-sm-9 col-xs-12">
			...
			<div class="pull-left alert form" style="width:700px;position:relative;" id="form3">
				<div class="arrow_in"></div>
				<h4 style="margin-top:20px;">优惠券详情</h4>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label"><span class="text-danger">*</span> 优惠详情</label>
					<div class="col-sm-9 col-xs-12">
...
<script>
	...
	$('#coupon-submit').click(function(){
		...
		if(!$.trim($(':input[name="title"]').val())) {
			util.message('优惠券标题不能为空', '','error');
			return false;
		}

		var time_type = $(':radio[name="time_type"]:checked').val();
		if(!time_type) {
			util.message('请完善优惠券有效期', '','error');
			return false;
		}
		...
		$.post("<?php  echo url('wechat/card/general_coupon', array('op' => 'post_save'))?>", {'data' : data}, function(out){
			var out = $.parseJSON(out);
			if(!out.errno) {
				util.message(out.error, '', 'error');
			} else {
				util.message('添加优惠券成功', "<?php  echo url('wechat/card/display');?>", 'success');
			}
			...
			<div class="panel-body">
				...
				<div class="shop-detail">
					<ul class="list">
						<li>
							<div class="li-panel">
								<div class="li-content">优惠券设置</div>
								<span class="ricon fa fa-angle-right"></span>
								<div class="cicon">
									<a href="javascript:;" data-id="form3"><i class="fa fa-pencil"></i></a>
								</div>
