	...
	<form class="form-horizontal form" id="form1" action="" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-sm-10 col-xs-12">
				...
				<span class="help-block">模块标识符, 应对应模块文件夹的名称, 【10:10】系统按照此标识符查找模块定义, 只能由字母数字下划线组成 </span>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-10 col-xs-12">
				<input type="text" class="form-control" placeholder="" name="application[url]" value="http://bbs.we7.cc/" />
				<span class="help-block">模块的发布页, 用于发布模块更新信息的页面, 推荐使用【10:10】模块版块</span>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-10 col-xs-12">
				...
				<?php  } } ?>
				<span class="help-block">订阅特定的消息类型后, 此消息类型的消息到达【10:10】系统后将会以通知的方式(消息数据只读, 并不能返回处理结果)调用模块的接受器, 用这样的方式可以实现全局的数据统计分析等功能. 请参阅 <a href="http://www.we7.cc/docs/#flow-module-subscribe">模块消息订阅</a></span>
				<div class="alert-warning alert">注意: 订阅的消息信息是只读的, 只能用作分析统计, 不能更改, 也不能改变【10:10】处理主流程</div>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">是否支持使用优惠券</label>
			<div class="col-sm-10 col-xs-12">
				<label class="checkbox-inline">
					<input type="checkbox" name="platform[card]" value="true" />
					支持优惠券
				</label>
				<div class="alert-warning alert">
					设置支持优惠券后，运营者在创建（代金券和折扣券）时,当前设计的模块将出现在（适用模块列表）。<br>
					模块需引导粉丝领取该优惠券。领取后，粉丝在该模块需要支付金钱时,可选择使用该优惠券来减免金额
				</div>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10 col-xs-12">
				...
				<?php  } } ?>
				<span class="help-block">当前模块兼容的【10:10】系统版本, 安装时会判断版本信息, 不兼容的版本将无法安装</span>
			</div>
		</div>
		<div class="form-group">
