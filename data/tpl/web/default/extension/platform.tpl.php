	...
	<div class="clearfix">
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<input type="text"  name="appid" value="<?php  echo $_W['setting']['platform']['appid'];?>" class="form-control">
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<input type="text"  name="appsecret" value="<?php  echo $_W['setting']['platform']['appsecret'];?>" class="form-control">
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<div class="input-group">
					<input type="text" readonly name="" value="<?php  echo $url['host'];?>" class="form-control">
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<div class="input-group">
					<input type="text" readonly name="" value="<?php  echo $url['host'];?><?php  echo $url['path'];?>web/index.php?c=account&a=auth&do=test" class="form-control">
					<span class="input-group-addon js-clip" style="cursor:pointer">复制</span>
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<div class="input-group">
					<input type="text" readonly name="" value="<?php  echo $url['host'];?><?php  echo $url['path'];?>web/index.php?c=account&a=auth&do=ticket" class="form-control">
					<span class="input-group-addon js-clip" style="cursor:pointer">复制</span>
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<div class="input-group">
					<input type="text" name="platform_token" class="form-control" value="<?php  echo $_W['setting']['platform']['token'];?>"  />
					<span class="input-group-addon js-clip" style="cursor:pointer">复制</span>
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<div class="input-group">
					<input type="text"  name="encodingaeskey" class="form-control" value="<?php  echo $_W['setting']['platform']['encodingaeskey'];?>" />
					<span class="input-group-addon js-clip" style="cursor:pointer">复制</span>
		...
		<div class="form-group">
			...
			<div class="col-sm-9 col-xs-12">
				<div class="input-group">
					<input type="text" readonly name="" value="<?php  echo $url['host'];?>/api.php?appid=/$APPID$" class="form-control">
					<span class="input-group-addon js-clip" style="cursor:pointer">复制</span>
				</div>
			</div>
		</div>
