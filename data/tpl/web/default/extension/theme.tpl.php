				...
				try {
					...
					$('.upgrade-label').each(function(){
						...
						if(ret[n]) {
							...
							if(ret[n].version > v) {
								upgrade.push(n);
								$(this).html('<div class="img-rounded update-bg"></div><div class="update-div"><a href="<?php  echo url('extension/theme/upgrade')?>&templateid=' + n + '" class="btn-danger img-circle update-btn" title="来自【10:10】云服务更新">更新</a></div>');
							}
						}
					});
					if(upgrade.length > 0) {
