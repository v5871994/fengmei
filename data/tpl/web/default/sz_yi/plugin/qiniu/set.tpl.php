            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <label class="radio-inline">
                        <input type="radio" name="user[upload]" value="1" <?php  if($set['user']['upload']==1) { ?> checked="checked"<?php  } ?>/>开启
                    </label>
                     <label class="radio-inline">
                        <input type="radio" name="user[upload]" value="0" <?php  if(empty($set['user']['upload'])) { ?> checked="checked"<?php  } ?>/>关闭
                    </label>
