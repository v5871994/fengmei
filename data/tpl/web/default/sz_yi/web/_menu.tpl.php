...
<div class='topmenu'>
    <ul class="nav navbar-nav">
        <li>
            <a href="<?php  echo url('home/welcome/ext',array('m'=>'sz_yi'))?>"><i class='fa fa-home'></i> <?php  echo $this->module['title']?></a> 
        </li> 
        <?php if(cv('shop')) { ?>
        <li class="dropdown">
        ...
        <li class="dropdown">
         ...
         <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                  ...
                  <?php if(cv('sysset.view.sms')) { ?><li><a href="<?php  echo $this->createWebUrl('sysset',array('op'=>'sms'))?>">短信设置</a></li><?php  } ?>
