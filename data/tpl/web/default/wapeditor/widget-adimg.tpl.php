<?php defined('IN_IA') or exit('Access Denied');?><div ng-controller="adImgCtrl">
<?php  if($_GPC['iseditor']) { ?>
	...
	<!--end图片广告-->
<?php  } else { ?>
	<link href="../app/resource/components/swiper/swiper.min.css" rel="stylesheet">
	<!--app图片广告-->
	<div class="app-adImg">
		<div class="inner">
			<div class="appstyle js-default-content" ng-if="module.params.items.length == 0">
				...
				<img ng-show="module.params.listStyle == 2" src="./resource/images/app/adImg-separate.jpg"><!--分开显示-->
			</div>
			<!--折叠轮播-->
