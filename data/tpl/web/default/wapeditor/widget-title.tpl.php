<?php defined('IN_IA') or exit('Access Denied');?><div ng-controller="titleCtrl">
	...
	<div class="app-title">
		<div class="inner">
			...
			<div ng-if="module.params.template == 2" class="title-detail text-left wx">
				...
				<p class="sub-title"><span class="date" ng-bind="module.params.news.date">2015-03-12</span>&nbsp;&nbsp;<span class="author" ng-bind="module.params.news.author">zhangsan</span>&nbsp;&nbsp;<span><a href="{{module.params.news.url}}" ng-bind="module.params.news.title">【10:10】团队</a></span></p>
			</div>
		</div>
	</div>
	<!--end标题-->
