<?php defined('IN_IA') or exit('Access Denied');?><div ng-controller="textNavCtrl">
				...
				<div class="panel-body form-horizontal">
					<div class="card add-textNav-con" ng-repeat="item in activeItem.params.items">
						...
						<div class="form-group">
							...
							<div class="col-xs-9">
								<input type="text" class="form-control" name="" ng-class="{'red': item.title == ''}" ng-model="item.title" value="">
							</div>
						</div>
						<div class="form-group">
					...
					<div class="add-textNav card">
						<a href="javascript:" ng-click="addItem()"><i class="fa fa-plus-circle green"></i>  添加一个文本导航</a>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="app-textNav">
		<div class="inner">
			<div class="list-group">
				<div class="list-group-item" ng-repeat="item in module.params.items">
