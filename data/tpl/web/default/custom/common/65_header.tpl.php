	...
	<div class="navbar navbar-inverse navbar-static-top" role="navigation" style="position:static;">
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				...
				<?php  if(IMS_FAMILY != 'x') { ?>
				<li><a href="http://bbs.we7.cc"><i class="fa fa-comment"></i>【10:10】论坛</a></li>
				<li><a href="http://wpa.qq.com/msgrd?v=3&uin=654789962&site=qq&menu=yes"><i class="fa fa-suitcase"></i>联系客服</a></li>
				<?php  } ?>
			</ul>
