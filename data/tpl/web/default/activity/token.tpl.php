		...
		<table class="table table-hover">
			...
			<tr>
				...
				<td style="text-align:right;">
					...
					<a href="<?php  echo url('activity/token/record', array('couponid' => $item['couponid']))?>" title="兑换记录">兑换记录</a>
				</td>
			</tr>
			<?php  } } ?>
			</tbody>
		...
		<table class="table table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td class="text-center">
						<a onclick="if(!confirm('删除后不可恢复,您确定删除吗?')) return false;"  href="<?php  echo url('activity/coupon/record-del', array('id' => $item['recid']))?>" title="删除兑换记录">删除兑换记录</a>
					</td>
				</tr>
				<?php  } } ?>
			</tbody>
