				...
				<div class="tab-content">
					<div class="tab-pane  active" id="tab_basic">
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-8">
								<label class="radio radio-inline">
									<input type="radio" name="status" value="1" <?php  if(intval($settings['status']) == 1) { ?>checked="checked"<?php  } ?>> 【10:10】支付接口
								</label>
								<label class="radio radio-inline">
									<input type="radio" name="status" value="2" <?php  if(intval($settings['status']) == 2) { ?>checked="checked"<?php  } ?>> 微信原生接口（限微信支付）
								</label>
								<span class="help-block">【10:10】支付接口支付方式更多，但可能会出现提示用户登录的问题。</span>
							</div>
						</div>
						<div class="form-group">
