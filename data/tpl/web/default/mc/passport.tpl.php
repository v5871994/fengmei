		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<label class="radio-inline">
							<input type="radio" name="passport[focusreg]" value="1" <?php  if(!empty($passport['focusreg'])) { ?> checked="checked"<?php  } ?>/> 会员手动注册
						</label>
						<label class="radio-inline">
							<input type="radio" name="passport[focusreg]" value="0" <?php  if(empty($passport['focusreg'])) { ?> checked="checked"<?php  } ?>/> 系统自动注册
						</label>
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<label class="radio-inline">
							<input type="radio" name="passport[audit]" value="1" <?php  if($passport['audit'] == 1) { ?> checked="checked"<?php  } ?>/> 是
						</label>
						<label class="radio-inline">
							<input type="radio" name="passport[audit]" value="0" <?php  if(empty($passport['audit'])) { ?> checked="checked"<?php  } ?>/> 否
						</label>
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						...
						<span class="help-block"><strong>注意: 使用随机密码或者混合密码时, 必须先 <a href="<?php  echo url('profile/notify');?>" target="_blank">设置邮件</a> 或 <a href="<?php  echo url('account/post', array('uniacid' => $_W['uniacid']));?>" target="_blank">短信</a> 选项</strong></span>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group" id="account">
					...
					<div class="col-sm-9 col-xs-12">
						<select name="oauth" class="form-control">
			...
			<div class="panel-body">
				<div class="form-group" id="account">
					...
					<div class="col-sm-9 col-xs-12">
						<input type="text" name="host" value="<?php  echo $oauth['host'];?>" class="form-control" />
						<span class="help-block">适用于您的微站或是活动有多个域名的情况下，由此域名做统一的oauth授权用</span>
					</div>
				</div>
			</div>
		</div>
