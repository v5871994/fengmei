...
<ul class="nav nav-tabs">
	<li<?php  if($do == 'display') { ?> class="active"<?php  } ?>><a href="<?php  echo url('mc/business/dispaly');?>">商家列表</a></li>
	<li<?php  if($do == 'post') { ?> class="active"<?php  } ?>><a href="<?php  echo url('mc/business/post');?>"><?php  if($id > 0) { ?>编辑商家<?php  } else { ?>添加商家<?php  } ?></a></li>
</ul>
<?php  if($do == 'post') { ?>
<div class="clearfix">
				...
				<div class="panel-body table-responsive">
					<table class="table table-hover">
						...
						<tr>
							...
							<td><a href="<?php  echo url('mc/business/post',array('id' => $item['id'],'do' =>'post'));?>" title="编辑">编辑</a>&nbsp;-&nbsp;
								<a href="<?php  echo url('mc/business/delete', array('id' => $item['id'], 'do' => 'delete'))?>" onclick="return confirm('此操作不可恢复，确认删除？');return false;" title="删除">删除</a>&nbsp;-&nbsp;</td>
						</tr>
						<?php  } } ?>
						</tbody>
					</table>
