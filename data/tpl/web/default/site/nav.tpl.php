			...
			<form action="./index.php" method="get" class="form-horizontal" role="form" id="form1">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-md-8 col-lg-8 col-xs-12">
						<select class="form-control" name="multiid" id="search">
							<?php  if(is_array($multis)) { foreach($multis as $multi) { ?>
								<option value="<?php  echo $multi['id'];?>" <?php  if($multi['id'] == $_GPC['multiid'] || ($multi['id'] == $default_site && $_GPC['multiid'] == '')) { ?>selected<?php  } ?>><?php  echo $multi['title'];?><?php  if($default_site == $multi['id']) { ?>[默认微站]<?php  } ?></option>
							<?php  } } ?>
						</select>
					</div>
				</div>
			...
			<table class="table table-hover">
					...
					<tr>
						...
						<td class="text-center" style="width:100px;">
							<div class="text-center" >
								<a href="<?php  echo url('site/nav/'.$_GPC['do'], array('id' => $item['id'],'foo' =>'post', 'mtid' => $_GPC['mtid'], 'f' => $_GPC['f']));?>" class="btn btn-default btn-sm">编辑</a>
								<a href="<?php  echo url('site/nav/'.$_GPC['do'], array('id' => $item['id'],'foo'=>'delete', 'name' => $modulename));?>" class="btn btn-default btn-sm">删除</a>
							</div>
						</td>
					</tr>
					<?php  } ?>
				...
				<tr>
					...
					<td class="text-center" style="width:100px;">
						<?php  if($item['remove']) { ?>
						<div class="text-center">
							<a class="btn btn-default btn-sm" href="<?php  echo url('site/nav/'.$_GPC['do'], array('id' => $item['id'],'foo' =>'post'));?>" title="编辑">编辑</a>
							<a class="btn btn-default btn-sm" href="<?php  echo url('site/nav/'.$_GPC['do'], array('id' => $item['id'],'foo'=>'delete', 'name' => $modulename));?>" title="删除">删除</a>
						</div>
						<?php  } ?>
					</td>
				</tr>
