			...
			<div class="panel-body table-responsive">
				<table class="table table-hover">
					...
					<tbody id="account-package">
						<tr>
							<td><input type="checkbox" name="package[]" value="-1" <?php  if(is_array($owner['group']['package']) && in_array('-1', $owner['group']['package'])) { ?>checked disabled<?php  } ?>/></td>
							<td>所有服务</td>
							<td>
						...
						<tr>
							<td><input type="checkbox" name="package[]" <?php  if(is_array($owner['group']['package']) && in_array($package['id'], $owner['group']['package'])) { ?>checked disabled<?php  } ?> <?php  if(is_array($extend['package']) && !empty($extend['package'][$package['id']])) { ?>checked <?php  } ?> value="<?php  echo $package['id'];?>" /></td>
