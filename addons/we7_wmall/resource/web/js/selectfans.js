...
var selectFans = {
	...
	'init' : function(callback, options) {
		...
		$this.modalobj = $('#select-fans-Modal');
		alert($this.modalobj.html())
	...
	'buildHtml' : function() {
		var dialog = {};
		dialog['mainDialog'] = '<div id="select-fans-Modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">\n' +
