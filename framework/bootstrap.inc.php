...
if(!file_exists($configfile)) {
	if(file_exists(IA_ROOT . '/install.php')) {
		...
		echo "&nbsp;&nbsp;<a href='http://www.we7.cc' style='font-size:12px' target='_blank'>Power by WE7 0.7 &nbsp;【10:10】公众平台自助开源引擎</a>";
		exit();
	} else {
		header('Content-Type: text/html; charset=utf-8');
...
if (!empty($_W['setting']['remote']['type'])) {
	$_W['attachurl'] = ($_W['setting']['remote']['type'] == 1) ? $_W['setting']['remote']['ftp']['url'] . '/' : $_W['setting']['remote']['alioss']['url'].'/';
}
