...
function cloud_prepare() {
	...
	if(empty($_W['setting']['site']['key']) || empty($_W['setting']['site']['token'])) {
		return error('-1', "您的程序需要在【10:10】云服务平台注册你的站点资料, 来接入云平台服务后才能使用相应功能.");
	}
	return true;
}
...
function cloud_m_upgradeinfo($name, $file_token) {
...
function _cloud_shipping_parse($dat, $file) {
	...
	if ($dat['content'] == 'blacklist') {
		return error(-1, '抱歉，您的站点已被列入云服务黑名单，云服务一切业务已被禁止，请联系【10:10】客服！');
	}
